...
| `swift run --package-path macos/BruceApp PanelViewModelHarness` | 面板 view model 映射边界测试 (措辞, 分组, 条件渲染, 用量档位与热力图, 按月聚合, 模型用量三档窗口, Nothing 绿阶系列色, Codex 账号上次成功时间, DeepSeek 月度映射); 46 项 |
