...
pub(crate) fn write_if_enabled(
    ...
    let payload = json!({
        ...
        "duplicate_files_skipped": stats.duplicate_files_skipped,
        "duplicate_session_groups": stats.duplicate_session_groups,
        "conflict_session_groups": stats.conflict_session_groups,
